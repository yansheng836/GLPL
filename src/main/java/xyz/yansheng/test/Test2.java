...
public class Test2 {
    ...
    public static void main(String[] args) {
        ...
        HtmlPage page = null;
        try {
            page = webClient.getPage("https://leetcode-cn.com/problemset/all/");// 尝试加载上面图片例子给出的网页
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            webClient.close();
...
//        System.out.println(document.text());
        Element tbodyElement = document.selectFirst("tbody.reactable-data");
        System.out.println(tbodyElement.text());
//        List<Element> infoListEle =
//            document.getElementById("feedCardContent").getElementsByAttributeValue("class", "feed-card-item");// 获取元素节点等
